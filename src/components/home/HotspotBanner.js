      ...
      <div className="relative rounded-2xl overflow-hidden">
        {image ? (
          ...
          <div className="w-full aspect-[2/1] relative overflow-hidden flex items-center justify-center"
            style={{ background: 'linear-gradient(135deg, #2456D8 0%, #1B44B8 50%, #F47920 100%)' }}>
        ...
        {spots.map((spot, idx) => (
          <Link key={idx} href={spot.href || '/shop'} className="absolute group" style={{ top: spot.top, left: spot.left }}>
            <span className="relative flex h-6 w-6">
              ...
              <span className="relative inline-flex rounded-full h-6 w-6 bg-primary-600 border-2 border-white shadow-lg" />
            </span>
