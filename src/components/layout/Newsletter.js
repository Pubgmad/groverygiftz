...
export default function Newsletter({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[8rem] opacity-[0.05] pointer-events-none select-none">💌</div>
      ...
      <div className="max-w-2xl mx-auto text-center px-4 relative z-10">
        <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white border border-white/30 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-[0.18em] mb-4">
          ✉️ {badge}
        </div>
